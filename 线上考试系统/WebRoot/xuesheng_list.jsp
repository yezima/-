...
<td> <% 
 HashMap mapxueke1 = new CommDAO().find("SELECT xuekemingcheng FROM xueke where id='"+map.get("xueke")+"'"); 
 %><%= mapxueke1.get("xuekemingcheng") %> </td>
<td> <% 
 HashMap mapbanji2 = new CommDAO().find("SELECT banjimingcheng FROM banji where id='"+map.get("banji")+"'"); 
 %><%= mapbanji2.get("banjimingcheng") %> </td>
