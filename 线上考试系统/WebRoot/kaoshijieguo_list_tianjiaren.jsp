...
<div class="panel panel-default">
    ...
    类型
                            ...
                            <select class="form-control class_leixing39" data-value="<%= request.getParameter("leixing") !=null ? request.getParameter("leixing") : "" %>" id="leixing" name="leixing">
<option value="">请选择</option><option value="单选题">单选题</option>
<option value="多选题">多选题</option>

</select>
<script>
$(".class_leixing39").val($(".class_leixing39").attr("data-value"))</script>
