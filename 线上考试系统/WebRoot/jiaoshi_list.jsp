...
// 以下是检测搜索框中是否填写了或者选择了什么，则写入sql 语句中
             ...
             if(request.getParameter("gonghao") != null && !"".equals( request.getParameter("gonghao") )){ where+=" AND gonghao LIKE '%"+request.getParameter("gonghao")+"%'"; } 
...
where+=" AND xingbie ='"+request.getParameter("xingbie")+"'"; } 
        ...
        List<HashMap> list = Query.make("jiaoshi").where(where).order(orderby+" "+sort).page(15);
...
<div class="panel panel-default">
    ...
    性别
                            ...
                            <select class="form-control class_xingbie14" data-value="<%= request.getParameter("xingbie") !=null ? request.getParameter("xingbie") : "" %>" id="xingbie" name="xingbie">
...
<td> <% if( "".equals( map.get("touxiang") ) ){ %>-<% } else { %><img width="100" src="<%= map.get("touxiang") %>"/><% } %> </td>
                        ...
                        <td align="center">
                                                                                    ...
                                                                                    <a href="jiaoshi_updt.jsp?id=<%= map.get("id") %>">修改</a>
                            <a href="jiaoshi.jsp?a=delete&id=<%= map.get("id") %>" onclick="return confirm('真的要删除？')">删除</a>
                            <!--qiatnalijne-->
                        </td>
                    </tr>
                    <% } %>
