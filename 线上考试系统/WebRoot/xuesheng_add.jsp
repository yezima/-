        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="xuesheng.jsp?a=insert" method="post" name="form1" id="form1"><!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="text" class="form-control" style="width:150px;" data-rule-required="true"
                                       ...
                                       data-msg-remote="内容重复了" id="xuehao" name="xuehao" value=""/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label style="width: 120px;min-height:18px;text-align: right" class="col-sm-2">学科<span
                                    style="color: red;">*</span></label>
                            <div class="col-sm-8">

                                <select class="form-control class_xueke3" data-value="" data-rule-required="true"
                                        data-msg-required="请填写学科" id="xueke" name="xueke" style="width:250px">
                                    <%
                                        List<HashMap> select = new CommDAO().select("SELECT * FROM xueke ORDER BY id desc");
                                    %>
                                    <% for (HashMap m : select) { %>
                                    <option value="<%= m.get("id") %>"><%= m.get("xuekemingcheng") %>
                                    </option>
                                    <% } %>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label style="width: 120px;min-height:18px;text-align: right" class="col-sm-2">班级<span
                                    style="color: red;">*</span></label>
                            <div class="col-sm-8">

                                <select class="form-control class_banji4" data-value="" data-rule-required="true"
                                        data-msg-required="请填写班级" id="banji" name="banji" style="width:250px">
                                    <%
                                        select = new CommDAO().select("SELECT * FROM banji ORDER BY id desc");
                                    %>
                                    <% for (HashMap m : select) { %>
                                    <option value="<%= m.get("id") %>"><%= m.get("banjimingcheng") %>
                                    </option>
                                    <% } %>
