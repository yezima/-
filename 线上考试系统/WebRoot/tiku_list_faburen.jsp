            ...
            <div class="">
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr id="<%= map.get("id") %>" pid="">
                        ...
                        <td><%
                            HashMap mapbanji4 = new CommDAO().find("SELECT banjimingcheng FROM banji where id='" + map.get("kaoshibanji") + "'");
                        %><%= mapbanji4.get("banjimingcheng") %>
                        </td>
                        ...
                        <td align="center">
                            ...
                            <a href="shiti_add.jsp?id=<%= map.get("id") %>">试题发布</a>
                           <%-- <a href="shiti_list.jsp?tikuid=<%= map.get("id") %>">试题查询</a>
                            <a href="jieguo_add.jsp?id=<%= map.get("id") %>">结果添加</a>
                            <a href="jieguo_list.jsp?tikuid=<%= map.get("id") %>">结果查询</a>
                            <a href="kaoshijieguo_add.jsp?id=<%= map.get("id") %>">考试结果添加</a>
                            <a href="kaoshijieguo_list.jsp?tikuid=<%= map.get("id") %>">考试结果查询</a>--%>
