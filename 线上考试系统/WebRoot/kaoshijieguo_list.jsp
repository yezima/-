...
// 以下是检测搜索框中是否填写了或者选择了什么，则写入sql 语句中
    ...
    where += " AND tikuid='"+request.getParameter("tikuid")+"' ";
                 ...
                 if(request.getParameter("tikumingcheng") != null && !"".equals( request.getParameter("tikumingcheng") )){ where+=" AND tikumingcheng LIKE '%"+request.getParameter("tikumingcheng")+"%'"; } 
                     ...
                     if(request.getParameter("danxuantidefen_start") != null && !"".equals( request.getParameter("danxuantidefen_start") )){ where+= " AND danxuantidefen >='"+request.getParameter("danxuantidefen_start")+"' "; }      
 if(request.getParameter("danxuantidefen_end") != null && !"".equals( request.getParameter("danxuantidefen_end") )){ where+= " AND danxuantidefen <='"+request.getParameter("danxuantidefen_end")+"' "; }                    List<HashMap> list = Query.make("kaoshijieguo").where(where).order(orderby+" "+sort).page(15);
...
<div class="panel panel-default">
    ...
    单选题得分
                            ...
                            <input type="text" class="form-control" style="width:80px;" name="danxuantidefen_start" value="<%= request.getParameter("danxuantidefen_start") !=null ? request.getParameter("danxuantidefen_start") : "" %>"/>-
<input type="text" class="form-control" style="width:80px;" name="danxuantidefen_end" value="<%= request.getParameter("danxuantidefen_end") !=null ? request.getParameter("danxuantidefen_end") : "" %>"/>                        
</div>
...
<td> <%= map.get("kaoshiren") %> </td>
                        ...
                        <td align="center">
                            ...
                            <a href="kaoshijieguo.jsp?a=delete&id=<%= map.get("id") %>" onclick="return confirm('真的要删除？')">删除</a>
                            <!--qiatnalijne-->
                        </td>
                    </tr>
                    <% } %>
