...
<%
    ...
    HashMap mmm = new CommDAO().getmap(request.getParameter("id") , "shiti");
    %>
...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="shiti.jsp?a=update" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <textarea style="width: 80%;height: 120px" class="form-control" data-rule-required="true" data-msg-required="请填写试题题目" id="shititimu" name="shititimu"><%= Info.html(mmm.get("shititimu")) %></textarea>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <select class="form-control class_leixing23" data-value="<%= Info.html(mmm.get("leixing")) %>" id="leixing" name="leixing" style="width:250px">
...
$(".class_leixing23").val($(".class_leixing23").attr("data-value"))</script>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                ...
                <input type="hidden" id="daan" name="daan"/>    <script>
