...
<div class="panel panel-default">
    ...
    类型
                            ...
                            <select class="form-control class_leixing21" data-value="<%= request.getParameter("leixing") !=null ? request.getParameter("leixing") : "" %>" id="leixing" name="leixing">
...
<script>
$(".class_leixing21").val($(".class_leixing21").attr("data-value"))</script>
