...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <select class="form-control class_xingbie8" data-value="<%= Info.html(mmm.get("xingbie")) %>" id="xingbie" name="xingbie" style="width:250px">
...
$(".class_xingbie8").val($(".class_xingbie8").attr("data-value"))</script>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <select class="form-control class_xueke9" data-value="<%= Info.html(mmm.get("xueke")) %>" data-rule-required="true" data-msg-required="请填写学科" id="xueke" name="xueke" style="width:250px">
<% 
...
<script>
$(".class_xueke9").val($(".class_xueke9").attr("data-value"))</script>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <select class="form-control class_banji10" data-value="<%= Info.html(mmm.get("banji")) %>" data-rule-required="true" data-msg-required="请填写班级" id="banji" name="banji" style="width:250px">
<% 
...
<script>
$(".class_banji10").val($(".class_banji10").attr("data-value"))</script>
