...
<%
    ...
    , (String)request.getSession().getAttribute("username") , "jiaoshi");
...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="jiaoshi.jsp?a=update" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    
                                                        <div class="form-group">
    <div class="row">
        <label style="width: 120px;min-height:18px;text-align: right" class="col-sm-2">工号<span style="color: red;">*</span></label>
        <div class="col-sm-8">
            
                                                    <input type="text" class="form-control" style="width:150px;" data-rule-required="true" data-msg-required="请填写工号" remote="factory/checkno.jsp?checktype=update&id=<%= mmm.get("id") %>&table=jiaoshi&col=gonghao" data-msg-remote="内容重复了" id="gonghao" name="gonghao" value="<%= Info.html(mmm.get("gonghao")) %>"/>                                            
        </div>
    </div>
</div>
                                                                            <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <select class="form-control class_xingbie16" data-value="<%= Info.html(mmm.get("xingbie")) %>" id="xingbie" name="xingbie" style="width:250px">
<option value="男">男</option>
<option value="女">女</option>

</select>
<script>
$(".class_xingbie16").val($(".class_xingbie16").attr("data-value"))</script>
