...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <select class="form-control class_xingbie11" data-value="" id="xingbie" name="xingbie" style="width:250px">
...
<option value="女">女</option>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <select class="form-control class_xueke12" data-value="" data-rule-required="true" data-msg-required="请填写学科" id="xueke" name="xueke" style="width:250px">
<% 
...
<% } %>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <select class="form-control class_banji13" data-value="" data-rule-required="true" data-msg-required="请填写班级" id="banji" name="banji" style="width:250px">
<% 
