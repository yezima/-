...
<div style="padding: 10px">
    ...
    <% out.close(); %>
    <% } %>        <% HashMap readMap = Query.make("shijuan").where("id", request.getParameter("id")).find(); %>
...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="kaoshidefen.jsp?a=insert" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <%= readMap.get("shijuanbianhao") %><input type="hidden" id="shijuanbianhao" name="shijuanbianhao" value="<%= Info.html(readMap.get("shijuanbianhao")) %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <%= readMap.get("shijuanmingcheng") %><input type="hidden" id="shijuanmingcheng" name="shijuanmingcheng" value="<%= Info.html(readMap.get("shijuanmingcheng")) %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" id="danxuantidefen" name="danxuantidefen" value=""/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                                ...
                                                                <input type="hidden" name="shijuanid" value="<%= request.getParameter("id") !=null ? request.getParameter("id") : "" %>"/>
